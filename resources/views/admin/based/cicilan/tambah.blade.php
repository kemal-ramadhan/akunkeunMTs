...
@section('contain')
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800"><b>Data Referensi / Produk Cicilan Pembayaran / Tambah Baru</b></h1>

<div class="card col-sm-12 mb-5 shadow-sm">
    <div class="card-body text-gray-800">
      <h5 class="mb-3"><b>Detail Data</b></h5>

      <form action="/c_produk_cicilan" method="post">
      @csrf
      <div class="row">
        <div class="col-sm-6 mb-3">
          <label for="produk" class="form-label">Nama Cicilan Pembayaran</label>
          <input type="text" class="form-control" id="produk" name="cicilan" placeholder="Nama Cicilan Pembayaran">
        </div>
        <div class="col-sm-6 mb-3">
