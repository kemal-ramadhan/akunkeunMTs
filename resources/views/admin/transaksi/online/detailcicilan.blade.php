...
<h1 class="h3 mb-4 text-gray-800">
    <a href="/transaksi-cicilan-online/{{$status = 'Menunggu Konfirmasi'}}" class="btn">
...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="mb-2">
                                <h5 class="card-title bold-text mb-3">{{$riwayat->nama_cicilan}}</h5>
            ...
            <hr>
            <form action="/u_pembayaran_cicilan_online" method="post">
            @csrf
            <input type="hidden" name="IdCicilan" value="{{$detail[0]->IdCicilan}}">
